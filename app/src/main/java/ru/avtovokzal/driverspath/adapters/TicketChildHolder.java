...
public class TicketChildHolder extends ChildViewHolder {
	...
	public void bind(Ticket ticketInfo) {
		...
		mDispatchStation.setText(ticketInfo.getDispatchStationName() + "   " + "-");
		mArrivalStation.setText(ticketInfo.getArrivalStationName());
		...
		mTicketPrice.setText(ticketInfo.getPrice() + " " + "рублей");
	}
}
