package ru.avtovokzal.driverspath.details.fragment;
...
import ru.avtovokzal.driverspath.stations.fragment.StationsFragment;
import ru.avtovokzal.driverspath.details.mvp.PassengerInfoPresenter;
import ru.avtovokzal.driverspath.details.mvp.PassengerInfoView;
...
public class PassengerInfoFragment extends MvpAppCompatFragment implements PassengerInfoView {
    ...
    private void showView(StationTicket tickets) {
        ...
        if ("IN".equals(tickets.direction)) {
