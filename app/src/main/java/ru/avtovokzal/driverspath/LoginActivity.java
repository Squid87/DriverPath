...
public class LoginActivity extends MvpAppCompatActivity implements LoginView {
	...
	private String[] city = {"Барнаул", "Белокуриха", "Бийск", "Рубцовск"};
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		@SuppressLint("ResourceType")
		ArrayAdapter<?> adapterArrive = new ArrayAdapter<String>(this, R.layout.spinner_text, R.id.spinner_text1, city);
