...
public class Pref {
	...
	@SuppressLint("ApplySharedPref")
	public void saveDBKey(int k) {
		mSharedPreferences.edit().putInt(KEY_DB, k).commit();
	}

	public int loadDBKey() {
		return mSharedPreferences.getInt(KEY_DB, 1);
	}
}
